...
function parseGeneratedSession(snapshot) {
    ...
    const exercises = rawExercises.map((exercise) => {
        ...
        if (typeof candidate.exerciseId !== "string" ||
...
function resolveStrengthDays(value) {
...
export const plansRoutes = async (app) => {
    app.get("/plans/week", {
